...
gulp.task('less', gulp.series('clean', function () {
	...
	.pipe(tap(function(file) {
	    file.contents = Buffer.concat([
	    	file.contents,
	        Buffer.from(customless(require('fs').readFileSync('./src/css/orb.theme.less', 'utf8'), require('./src/css/theme.default.json')))
	    ]);
	}))
	// group classes
...
gulp.task('react', gulp.series('less', function() {
...
/*gulp.task('test', gulp.series('react', function () {
...
//gulp.task('debug', gulp.series('test', function() {
gulp.task('debug', gulp.series('react', function() {
...
gulp.task('minify', gulp.series('debug', function() {
